...
public class MyProxy {
    ...
    private static String getMethodString(Method[] methods, Class interfaces) {
        ...
        for (Method method:methods) {
            methodStringBuffer.append("public void ")
